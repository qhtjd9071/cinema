...
<div class="main">
	...
	<form action="${cp}/movie/insert" method="post">	
		<table>
			<tr>
				<th>제목</th>
			...
			<tr>
				...
				<input type="hidden" id="imgsrc" name="image">
			</tr>
		</table>
		<div class="btn_wrap">
			...
			if(fileInput!=null){
				...
				xhr.onreadystatechange=function(){
					if(xhr.readyState == 4 && xhr.status == 200){
						...
						img.src="${cp}/resources/upload/movie/"+fileName;
						imgsrc.value="${cp}/resources/upload/movie/"+fileName;
					}
				}
			xhr.open("post", "${cp}/fileUpload/movie", true);
	    	xhr.send(formData);
			}
		});
</script>
