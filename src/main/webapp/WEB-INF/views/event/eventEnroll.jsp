...
<link rel="stylesheet" href="${cp}/resources/css/movieEnroll2.css">
<link rel="stylesheet" href="${cp}/resources/css/ad_header.css">
...
<div class="main">
	...
	<form action="${cp}/event/insert" method="post">	
		<table>
			<tr>
				<th>제목</th>
			...
			<tr>
				...
				<input type="hidden" id="imgsrc1" name="mainImage">
				<br>
				상세사진선택
			    <input type="file" id="upload_file2" name="upload_file2">
				<input type="hidden" id="imgsrc2" name="detailImage">
			</tr>
		</table>
		<div class="btn_wrap">
		...
		imgBtn1.addEventListener("click",function(){
			...
			if(fileInput!=null){
				...
				xhr.onreadystatechange=function(){
					...
					img.src="${cp}/resources/upload/event/main/"+fileName;
					imgsrc1.value="${cp}/resources/upload/event/main/"+fileName;
					}
				}
			xhr.open("post", "${cp}/fileUpload/eventMain", true);
	    	xhr.send(formData);
			}
		});
		...
		imgBtn2.addEventListener("click",function(){
			...
			if(fileInput!=null){
				...
				xhr.onreadystatechange=function(){
					...
					img.src="${cp}/resources/upload/event/detail/"+fileName;
					imgsrc2.value="${cp}/resources/upload/event/detail/"+fileName;
					}
				}
			xhr.open("post", "${cp}/fileUpload/eventDetail", true);
	    	xhr.send(formData);
			}
		});
</script>
