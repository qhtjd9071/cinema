...
<link rel="stylesheet" href="${cp}/resources/css/csupdate.css">
...
<div class="content">
	<div class="content_container">
		...
		<form method="post" action="${cp}/customer/update">
			글번호<span class="nch">(변경불가)</span><br>
			<input class="num" type="text" name="id" value="${vo.id}" readonly="readonly"><br><br>
			
			작성자<span class="nch">(변경불가)</span><br>
			<input class="writer" type="text" name="userId" value="${vo.userId}" readonly="readonly"><br><br>
			...
			*글내용<br>
			...
			<input placeholder="자동등록"class="date" type="text"  value="${vo.createDate}" readonly="readonly"><br><br>
