...
<style>    
	...
	.myslide1_bg {width:100%; height:100%; background-image:url(${cp}/resources/images/main/Ella_1920774.jpg); background-size:cover; background-position:center; display:flex; flex-direction:column; justify-content:center;}
	.myslide2_bg {width:100%; height:100%; background-image:url(${cp}/resources/images/main/Spiral_1920774.jpg); background-size:cover; background-position:center; display:flex; flex-direction:column; justify-content:center;}
	.myslide3_bg {width:100%; height:100%; background-image:url(${cp}/resources/images/main/InTheHeights_1920774.jpg); background-size:cover; background-position:center; display:flex; flex-direction:column; justify-content:center;}
	.myslide4_bg {width:100%; height:100%; background-image:url(${cp}/resources/images/main/TheFast_1920774.jpg); background-size:cover; background-position:center; display:flex; flex-direction:column; justify-content:center;}
	.myslide5_bg {width:100%; height:100%; background-image:url(${cp}/resources/images/main/Place_1920774.jpg); background-size:cover; background-position:center; display:flex; flex-direction:column; justify-content:center;}
	.myslide6_bg {width:100%; height:100%; background-image:url(${cp}/resources/images/main/Line_1920774.jpg); background-size:cover; background-position:center; display:flex; flex-direction:column; justify-content:center;}
	.myslide7_bg {width:100%; height:100%; background-image:url(${cp}/resources/images/main/Voyagers_1920774.jpg); background-size:cover; background-position:center; display:flex; flex-direction:column; justify-content:center;}
	.myslide8_bg {width:100%; height:100%; background-image:url(${cp}/resources/images/main/Killer_1920774.jpg); background-size:cover; background-position:center; display:flex; flex-direction:column; justify-content:center;}
	.myslide9_bg {width:100%; height:100%; background-image:url(${cp}/resources/images/main/Luca_1920774.jpg); background-size:cover; background-position:center; display:flex; flex-direction:column; justify-content:center;}
	.myslide10_bg {width:100%; height:100%; background-image:url(${cp}/resources/images/main/Truck_1920774.jpg); background-size:cover; background-position:center; display:flex; flex-direction:column; justify-content:center;}
	.myslide11_bg {width:100%; height:100%; background-image:url(${cp}/resources/images/main/Conjuring_1920774.jpg); background-size:cover; background-position:center; display:flex; flex-direction:column; justify-content:center;}
</style>
</head>
