...
<div class="header">
	<div class="header_container">
		<h1><a href="${cp}/"><img src="${cp}/resources/images/login/logo.png"></a></h1>
	</div>
</div>
<div class="contents">
	<div class="contents_container">
		<h2 class="title">회원가입</h2>
		<form method="post" action="${cp}/member/join" class="join_form" onsubmit="return check()">
			<h3>
				회원정보입력
			...
			<div class="join1">
				...
				<div class="join_col_input">
					<div class="input_wrap">
						<div class="ui_input">
							<input type="text" name="birth" class="input_space" maxlength="20" placeholder="생년월일 8자리를 입력해주세요. (ex.19990625)">
						</div>
					</div>
				</div>
			</div>
...
<script type="text/javascript">
	...
	function check(){
		...
		var year=document.getElementsByName("birth")[0];
	...
	window.onload=function(e){
		...
		idoverlap.onclick=function(e){
			...
			xhr.open('get','${cp}/member/checkId?id=' + id,true);
			xhr.send();
		}
	};
