...
<body>
   ...
   <div class="movie">
      <div class="movie_container">
	      <ul class="mbtn_list">
		      <li><a href="${cp}/movie/insert" style="background-color:#444444; color:white;">영화 정보 등록</a></li>
		      <li><a href="${cp}/movie/list" style="background-color:#F8F8F8">영화 정보 보기</a></li>
		      <li><a href="${cp}/room/insert" style="background-color:#444444; color:white;">상영관 등록</a></li>
	      ...
	      <ul class="mbtn_list">
		      <li><a href="${cp}/event/insert" style="background-color:#444444; color:white;">이벤트 등록</a></li>
		      <li><a href="${cp}/event/list" style="background-color:#F8F8F8">이벤트 보기</a></li>
		      <li><a href="${cp}/customer/list" style="background-color:#444444; color:white;">문의내역 보기</a></li>
	      </ul>
      </div>
   </div>
