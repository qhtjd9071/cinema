...
<link rel="stylesheet" href="${cp}/resources/css/showEnroll.css">
</head>
<body>
...
<div class="content">
	<div class="content_container">
		<h1>상영등록</h1>
		<div class="wrapper">
			<form method="post" action="${cp}/show/insert" class="inputDiv">
				<ul>
					<li>
						<h3>영화제목</h3>
...
<script type="text/javascript">
	...
	function rlist(){
		...
		xhr.open("post", "${cp}/room/roomList", true);
		xhr.send();
	}
	rlist();
	function mlist(){
		...
		xhr.open("post", "${cp}/movie/movieList", true);
		xhr.send();
	}
	mlist();
