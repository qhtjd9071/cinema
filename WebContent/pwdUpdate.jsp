...
<body>
<h1>비밀번호 변경</h1>
<form method="post" action="pwdupdate" onsubmit="return pwdCheck()">
	<table>
		<tr>
			<td>현재 비밀번호</td>
			<td><input type="password" name="currpwd" id="currpwd"></td>
		</tr>
		<tr>
			<td>새 비밀번호</td>
		...
		<tr>
			<td>새 비밀번호 재입력</td>
			<td><input type="password" name="newpwd2" id="newpwd2"><span>※ 비밀번호 확인을 위해 한 번 더 입력해 주시기 바랍니다.</span></td>
		</tr>
	</table>
	<ul>
