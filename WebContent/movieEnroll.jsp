...
<div class="main">
	...
	<form action="${pageContext.request.contextPath}/admin?cmd=movieEnroll" method="post">
		...
		<table>
			...
			<tr>
				<th>감독</th>
				<td><input type="text" name="director" placeholder="좌석수를 입력해주세요." style="background-color: #F8F8F8;border-color: #DDD;width:800px;padding: 10px;font-size: 15px;"><td>
			</tr>
			<tr>
				<th>장르</th>
				<td><input type="text" name="genre" placeholder="위치를 입력해주세요." style="background-color: #F8F8F8;border-color: #DDD;width:800px;padding: 10px;font-size: 15px;"><td>
			</tr>
			<tr>
				<th>관람등급</th>
				<td><input type="text" name="rating" placeholder="상영관 번호를 입력해주세요." style="background-color: #F8F8F8;border-color: #DDD;width:800px;padding: 10px;font-size: 15px;"><td>
			</tr>
			<tr>
				<th>내용</th>
