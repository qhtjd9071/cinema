   ...
   <div class="movie">
      <div class="movie_container">
	      <ul class="mbtn_list">
		      ...
		      <li><a href="#" style="background-color:#F8F8F8">공지사항 등록</a></li>
		      <li><a href="#" style="background-color:#444444; color:white;">이벤트 등록</a></li>
	      </ul>
	      <ul class="mbtn_list">
		      ...
		      <li><a href="#" style="background-color:#F8F8F8">공지사항 보기</a></li>
		      <li><a href="#" style="background-color:#444444; color:white;">이벤트 보기</a></li>
	      </ul>
      </div>
   </div>
